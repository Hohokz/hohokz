            ...
            <div className={isSmall ? 'mini-bar' : 'menu-bar'} >
                ...
                <nav nav className="Heading">
                    <div className="flex ">
                        ...
                        <a href='https://www.linkedin.com/in/apiwat-singharach/' target="_blank"><svg className="m-[5px]" width="15" height="15" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
