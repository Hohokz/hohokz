            ...
            <nav className="pt-[5px] bg-white shadow-[0_-1px_28px_87px_-8px_rgba(0,0,0,0.36)] bg-opacity-80 fixed inset-x-0 top-0 flex-row ">
                ...
                <div className="z-60 sticky top-0 ">
                    <div className="static flex justify-between ">
                        <div className="">
                            <p className=" tracking-widest pt-[5px] mt-[80px] mb-[30px] flex text-md font-thin pl-5 text-gray-500 cursor-pointer" onClick={() => navigate('/')}>
                                APIWAT SINGHARACH /
                        ...
                        <div className="z-49  mt-[20px] ">
                            <div>
                                ...
                                <span className="p-[10px]  py-[72px] tracking-widest text-right text-gray-500 font-thin text-sm cursor-pointer"  onClick={() => navigate(`/cv`)}>BIO</span>
                            </div>
                        </div>
                    </div>
                </div>
