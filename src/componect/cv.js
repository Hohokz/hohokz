        ...
        <>
            ...
            flex-col items-start justify-start  text-thin ">
                    <div className="" >
                        ...
                        <p className="pt-[250px] ml-[20px] font-thin tracking-widest text-xs text-gray-800">
                        ...
                        <p className="ml-[20px] font-thin tracking-widest text-xs text-gray-800">
                            Bron 1990 in ChiangMai / Live and Learn in ChiangMai / Now ! I'm Software Development in Training
                        </p>
                        <p className="mt-[50px] mr-[45px] flex justify-center font-thin text-right tracking-widest text-lx text-black">
                            Educate
                        </p>
                        <p className="px-[30px] content-center flex-wrap-reverse flex flex-row  justify-between p-[20px] font-thin text-right tracking-widest text-xs text-gray-800">
                            2011
