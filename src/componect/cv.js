    ...
    return (
        <>
            ...
            <div class="flex md:flex-col justify-center">
                ...
                <div className="pt-[30px] w-[600px] bg-gray-500 
                                shadow-[0_-1px_28px_87px_-8px_rgba(0,0,0,0.36)] bg-opacity-30">
                    <div className="" >
                        <p className="pt-[20px] sm:px-[0px] sm:ml-[5px] sm:justify-start flex justify-center font-thin tracking-widest text-xs text-gray-800">
                            Bron 1990 in ChiangMai
                        </p>
                        <p className=" mt-[20px] sm:px-[0px] sm:ml-[5px] sm:justify-start flex justify-center font-thin tracking-widest text-xs text-gray-800">
                            Software Development in Training / Photographer / Flimmaker
                        </p>

                        <p className=" flex sm:px-[0px] sm:ml-[5px] sm:justify-start justify-center font-thin tracking-widest text-xs text-gray-800">
                            Live, life and Learn / Now ! I'm Software Development in Training
                        </p>
                        <p className="mt-[50px] sm:justify-start sm:pl-[5px]  flex justify-center font-thin tracking-widest text-lx text-black">
                            Educate
                        </p>
                        <p className="flex flex-row sm:px-[0px] sm:ml-[5px] sm:justify-start justify-between px-[50px] p-[20px] font-thin  tracking-widest text-xs text-gray-800">
                            2011
                            <span className="sm:ml-[20px] font-thin tracking-widest text-xs text-gray-600">
                                Information Science ChiangMai Rajabhat University
                            </span>
                        </p>

                        <p className=" mb-[20px] px-[50px] flex sm:justify-start sm:pl-[5px] justify-center font-thin tracking-widest text-lx text-black">
                            Experience
                        </p>
                        <div className="">
                            <p className="px-[50px] sm:px-[0px] sm:ml-[5px] sm:justify-start justify-between flex flex-row font-thin tracking-widest text-xs text-gray-800">
                                2011-2015
                                <span className=" sm:ml-[20px] font-thin tracking-widest text-xs text-gray-600">
                        ...
                        <div className="">
                            <p className=" sm:px-[0px] sm:ml-[5px] sm:justify-start px-[50px] flex justify-between flex-row font-thin tracking-widest text-xs text-gray-800">
                                2016-2017
                                <span className=" sm:ml-[20px] font-thin tracking-widest text-xs text-gray-600">
                        ...
                        <p className="sm:justify-start sm:pl-[5px] mb-[20px] mt-[30px] flex justify-center font-thin tracking-widest text-lx text-black">
                            Exhibition
                        </p>
                        <div className="">
                            <p className="sm:px-[0px] sm:ml-[5px] sm:justify-start px-[50px] flex flex-row justify-between font-thin  tracking-widest text-xs text-gray-800">
                                2016
                                <span className="sm:ml-[20px] font-thin  tracking-widest text-xs text-gray-600">
                        ...
                        <div className="content-center">
                            <p className="sm:px-[0px] sm:ml-[5px] sm:justify-start px-[50px] flex flex-row justify-between font-thin tracking-widest text-xs text-gray-800">
                                2018
                                <span className="sm:ml-[20px] font-thin text-left tracking-widest text-xs text-gray-600">
                        ...
                        <div className="p-[50px] sm:p-[0px] sm:justify-start flex justify-center">
